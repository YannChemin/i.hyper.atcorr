% XeLaTeX header for i.hyper.atcorr Programmer's Manual
% Generated from Doxygen 1.9.8 template, adapted for XeLaTeX + Unicode
  $latex_batchmode
...
%%END !COMPACT_LATEX
  ...
  % XeLaTeX Unicode support — replaces utf8 inputenc + fontenc
  \usepackage{fontspec}
...
%%END !COMPACT_LATEX
  ...
  % Compatibility shim: newunicodechar's \nuc@check may not be defined
  % when using XeLaTeX; \doxynewunicodechar needs it to accept any char.
  \makeatletter
