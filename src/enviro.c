 ...
 *
 * difr : diffuse Rayleigh optical depth at the target wavelength
 * difa : diffuse aerosol optical depth at the target wavelength
 * r    : total aerosol OD at 550 nm (for the nadir-view LUT lookup)
 * palt : sensor altitude (km)
 * xmuv : cosine of the view zenith angle
 *
 * Outputs:
 *   fra  : Rayleigh environmental function (fraction of env. contribution)
 *   fae  : aerosol environmental function
 *   fr   : combined fraction (weighted average of fra and fae) */
