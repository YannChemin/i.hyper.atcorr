...
/* 1-D least-squares line fit: returns slope b in ρ = a + b×wl.
 * Also sets *a_out to the intercept.  n must be ≥ 2. */
...
/* H₂O continuum interpolation depth (same physics as retrieve_h2o_940). */
